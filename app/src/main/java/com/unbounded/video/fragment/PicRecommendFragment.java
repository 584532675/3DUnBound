...
public class PicRecommendFragment extends BaseFragment {
    ...
    private void initPics(){
        ...
        if(!(TextUtils.isEmpty(selectStart)) && !("null".equals(selectStart)) && currentPage != 1){
            url = HttpConstants.selectRecommendImg_Url + "?currentPage=" + currentPage + "&selectStart="+selectStart;
        }else {
            url = HttpConstants.selectRecommendImg_Url + "?currentPage=" + currentPage;
        }
