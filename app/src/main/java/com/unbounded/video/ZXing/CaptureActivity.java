package com.unbounded.video.ZXing;
...
import com.unbounded.video.ZXing.decoding.CaptureActivityHandler;
import com.unbounded.video.ZXing.decoding.InactivityTimer;
import com.unbounded.video.ZXing.decoding.RGBLuminanceSource;
import com.unbounded.video.ZXing.view.ViewfinderView;
...
public class CaptureActivity extends Activity implements Callback, View.OnClickListener{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if(screenHeight == Constants.ZERO){
		...
		Button mButtonBack = (Button) findViewById(R.id.scan_back);
		titlerela = (RelativeLayout) findViewById(R.id.local_titlerela);
		...
		Button mImageButton = (Button) findViewById(R.id.scan_add_picture);
