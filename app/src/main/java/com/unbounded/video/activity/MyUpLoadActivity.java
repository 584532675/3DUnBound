...
/**
 * Created by zjf on 2017/9/26 0026.
 */

public class MyUpLoadActivity extends BaseActivity {
    TextView videotv,imagetv,videoflagtv,imageflagtv;
    ...
    protected int getContentView() {
        return com.unbounded.video.R.layout.activity_local;
    }
    ...
    public void init(Intent intent) {
        ...
        localimagefrag = new PicLocalFragment();
        fragmentList.add(localfilmfrag);
        fragmentList.add(localimagefrag);
    ...
    public void initView() {
        ...
        videoflagtv = (TextView) findViewById(com.unbounded.video.R.id.local_videotagtv);
        imagetv = (TextView) findViewById(com.unbounded.video.R.id.local_imagetv);
        imageflagtv = (TextView) findViewById(com.unbounded.video.R.id.local_imagetagtv);
        backbtn = (Button) findViewById(com.unbounded.video.R.id.local_backbtn);
    ...
    private void changeView(int desTab) {
        ...
        imagetv.setTextColor(getResources().getColor(com.unbounded.video.R.color.word_six_four));

        videoflagtv.setBackgroundResource(com.unbounded.video.R.color.white);
        imageflagtv.setBackgroundResource(com.unbounded.video.R.color.white);

        if(desTab == 0){
            videotv.setTextColor(getResources().getColor(com.unbounded.video.R.color.titleblue));
            videoflagtv.setBackgroundResource(com.unbounded.video.R.color.titleblue);
        }else if(desTab == 1){
            imagetv.setTextColor(getResources().getColor(com.unbounded.video.R.color.titleblue));
            imageflagtv.setBackgroundResource(com.unbounded.video.R.color.titleblue);
        }
    }
