...
public class NewYoutubeRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public NewYoutubeRecyclerAdapter(Context context, List<OnlineVideo> list, View mHeaderView, int imgWidth, int homePage) {
		super();
    ...
    public NewYoutubeRecyclerAdapter(Context context, List<OnlineVideo> list, View mHeaderView, int imgWidth) {
        super();
        this.context = context;
        this.list = list;
        this.mHeaderView = mHeaderView;
...
//        Log.e("info","imgurl="+imgurl);
        ...
        if(viewHolder instanceof Holder) {
            ...
            if("null".equals(list.get(pos).getName())){
                ((NewYoutubeRecyclerAdapter.Holder) viewHolder).nametv.setText(list.get(pos).getName());
            }else{
                ((NewYoutubeRecyclerAdapter.Holder) viewHolder).nametv.setText(list.get(pos).getName());
            }
