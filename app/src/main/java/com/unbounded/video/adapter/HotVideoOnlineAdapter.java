...
public class HotVideoOnlineAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public HotVideoOnlineAdapter(Context context, List<OnlineVideo> list, View mHeaderView, int imgWidth, int homePage) {
        super();
        ...
        imgHeight = imgWidth * 310/536;
    }
    public HotVideoOnlineAdapter(Context context, List<OnlineVideo> list, View mHeaderView, int imgWidth) {
        super();
        this.context = context;
        this.list = list;
        this.mHeaderView = mHeaderView;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View layout = LayoutInflater.from(parent.getContext()).inflate(com.unbounded.video.R.layout.hotvideoonline_item, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position) {
        ...
        if(viewHolder instanceof Holder) {
            ...
            if(homePage == 1){
                GlideLogic.glideLoadPicMemoryCache423(context, imgurl, ((Holder) viewHolder).img, imgWidth * 13/16, imgHeight * 13/16);
            }else{
                GlideLogic.glideLoadPic423(context, imgurl, ((Holder) viewHolder).img, imgWidth * 13/16, imgHeight * 13/16);
            }
